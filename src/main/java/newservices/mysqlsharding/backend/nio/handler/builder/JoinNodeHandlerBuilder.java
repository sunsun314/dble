...
import newservices.mysqlsharding.backend.nio.handler.query.impl.OrderByHandler;
import newservices.mysqlsharding.backend.nio.handler.query.impl.TempTableHandler;
import newservices.mysqlsharding.backend.nio.handler.query.impl.join.JoinHandler;
import newservices.mysqlsharding.backend.nio.handler.query.impl.join.NotInHandler;
...
class JoinNodeHandlerBuilder extends BaseHandlerBuilder {
    ...
    public void mergeBuild() {
        try {
            ...
            String schemaName = this.session.getService().getSchema();
            if (schemaName != null) {
