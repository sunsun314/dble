...
public final class DbGroupHaSwitch {
        ...
        try {
            ...
            if (ClusterConfig.getInstance().isNeedSyncHa()) {
                if (ClusterConfig.getInstance().isUseZK()) {
                    if (!switchWithZK(id, dh, masterName, service)) {
                        return;
                    }
                } else {
    ...
    private static boolean switchWithCluster(int id, PhysicalDbGroup dh, String subHostName, ManagerService service) {
    ...
    private static boolean switchWithZK(int id, PhysicalDbGroup dh, String subHostName, ManagerService service) {
