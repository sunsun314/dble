...
public final class ShowSysParam {
    ...
    public static void execute(ManagerService service) {
        ...
        for (ParamInfo info : paramValues) {
            ...
            row.add(StringUtil.encode(info.paramName, service.getCharset().getResults()));
            row.add(StringUtil.encode(info.paramValue, service.getCharset().getResults()));
            row.add(StringUtil.encode(info.paramDesc, service.getCharset().getResults()));
