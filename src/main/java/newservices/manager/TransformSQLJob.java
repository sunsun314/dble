...
import newcommon.proto.mysql.packet.RowDataPacket;
...
public class TransformSQLJob implements ResponseHandler, Runnable {
    ...
    @Override
    public boolean rowResponse(byte[] rowNull, com.actiontech.dble.net.mysql.RowDataPacket rowPacket, boolean isLeft, BackendConnection conn) {
        return false;
    }

    public void fieldEofResponse(byte[] header, List<byte[]> fields, List<com.actiontech.dble.net.mysql.FieldPacket> fieldPackets, byte[] eof, boolean isLeft, BackendConnection conn) {
