...
import com.actiontech.dble.sql.view.KVStoreRepository;
...
import com.actiontech.dble.common.config.loader.zkprocess.zktoxml.listen.DataHostResponseListener;
import com.actiontech.dble.common.config.loader.zkprocess.zktoxml.listen.DataHostStatusListener;
...
import com.actiontech.dble.sql.meta.table.AbstractSchemaMetaHandler;
import com.actiontech.dble.sql.meta.table.DDLNotifyTableMetaHandler;
import com.actiontech.dble.sql.meta.table.SchemaCheckMetaHandler;
import com.actiontech.dble.sql.meta.table.ServerMetaHandler;
...
public class ProxyMetaManager {
    ...
    public StructureMeta.TableMeta getSyncTableMeta(String schema, String tbName) throws SQLNonTransientException {
        Span span = TraceManager.getTracer().buildSpan("get-meta").start();
        span.log(ImmutableMap.of("table-name", schema + "." + tbName));
        try {
            while (true) {
